...
<body>
    ...
    <header class="header">
        ...
        <div class="follow">
            ...
            <a href="https://www.linkedin.com/in/xhevrije-neziri/" class="fab fa-linkedin"></a>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3 data-aos="fade-up">hi, i am xhevrije neziri</h3>
            <span data-aos="fade-up">Web Developer</span>
            <p data-aos="fade-up"> this is a personal portfolio</p>
    ...
    <section class="about" id="about">
        ...
        <div class="biography">
            ...
            <p data-aos="fade-up">My introduction</p>

            <div class="bio">
                <h3 data-aos="zoom-in"> <span>name : </span> Xhevrije Neziri </h3>
                <h3 data-aos="zoom-in"> <span>email : </span> xhevrijeneziri1@gmail.com </h3>
                <h3 data-aos="zoom-in"> <span>address : </span> Kaçanik, Kosovo </h3>
                <h3 data-aos="zoom-in"> <span>phone : </span> +383 -- --- --- </h3>
            ...
            <div class="row">
                ...
                <div class="box-container">
                    ...
                    <div class="box" data-aos="fade-right">
                        ...
                        <h3>UBT College</h3>
                        <p>Computer Science and Engieneering</p>
                    </div>
    ...
    <div class="credit"> copyright &copy; <?php echo date('Y'); ?> </div>
